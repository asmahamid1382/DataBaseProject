...
VALUES
('user1@example.com', NULL, 'password123', 'Boy', 'John', 'Doe', 'JD', 'Premium', 100, 500, 1990, 5, 15),
('user2@example.com', NULL, 'pass4562', 'Girl', 'Alice', 'Smith', 'AS', 'Free', 50, 200, 1985, 8, 21),
('user3@example.com', NULL, 'pass7891', 'Boy', 'Bob', 'Johnson', 'BJ', 'Premium', 120, 700, 1988, 11, 8);
...
(2, 2, 'Jazz', 3, 'English', 2, 2, '00:05:15', '2023-09-22', 40, NULL, 'Smooth Jazz', 'Instrumental track with saxophone.', 800, 'user2@example.com'),
...
INSERT INTO MusicCreatingPlaylist (Playlist_id, DateCreating, Music_id)
VALUES
(1, '2023-08-15', 1),
(2, '2023-09-01', 2),
(3, '2023-10-10', 3);
